...
app.service('bLanguage', ['$rootScope', '$http', '$q', '$timeout', '$translate', 'LANGUAGE_PATH', 'LANGUAGE_OBJECT_NAME', languageService]);
  ...
  function($rootScope, $http, bLanguage, LANGUAGE_DEFAULT)
  {
    bLanguage.getLanguages()
      .then(function(languages)
      {
        ...
        var defLang = sessionStorage.getItem('bLanguage.current') || window.navigator.userLanguage || window.navigator.language || LANGUAGE_DEFAULT;
