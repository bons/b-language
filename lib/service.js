...
function LanguageService($rootScope, $http, $q, $timeout, $translate, LANGUAGE_PATH)
{
  var self = this,
      languages = {},
    ...
    return $http({
        ...
        .then(function(r)
        {
          ...
          Object.keys(languages).forEach(function(key)
          {
            ...
            parsedLanguages[locale] = languages[key];
          });

          sessionStorage.setItem('bLanguage',  JSON.stringify(parsedLanguages));
